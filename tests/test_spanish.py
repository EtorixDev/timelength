...
from timelength import FailureFlags, ParserSettings, Scale, Spanish, TimeLength
...
def tl_notstrict() -> TimeLength:
    return TimeLength(content="0 segundos", locale=Spanish())


@pytest.fixture
def tl_strict() -> TimeLength:
    return TimeLength(content="0 segundos", locale=Spanish(flags=FailureFlags.ALL, settings=ParserSettings(allow_duplicate_scales=False)))
...
def generate_notstrict_tests() -> list[ParseCase]:
    ...
    cases.append(("dos de seis minutos", True, 720.0, (), ((12.0, Scale(scale=60.0)),)))
    cases.append(("2 de seis minutos", True, 720.0, (), ((12.0, Scale(scale=60.0)),)))
    cases.append(("dos de 6 minutos", True, 720.0, (), ((12.0, Scale(scale=60.0)),)))
    cases.append(("2 de", False, 0.0, (("de", FailureFlags.UNUSED_OPERATOR), (2.0, FailureFlags.LONELY_VALUE)), ()))
    ...
    cases.append(("un billón de billones de billones de billones de billones de años", True, 3.1536e67, (), ((1.0000000000000001e60, Scale(scale=31536000.0)),)))
    ...
    cases.append(("1/+ segundos", False, 0.0, (("1/+", FailureFlags.MALFORMED_FRACTION), ("segundos", FailureFlags.LONELY_SCALE)), ()))
    cases.append(("1:++ segundos", False, 0.0, (("1:+", FailureFlags.MALFORMED_HHMMSS), ("segundos", FailureFlags.LONELY_SCALE)), ()))
    cases.append(("un cien 5,segundos", True, 5.0, (), ((5.0, Scale(scale=1.0)),)))
    cases.append(("un cien cinco,segundos", True, 105.0, (), ((105.0, Scale(scale=1.0)),)))
    cases.append(("de", False, 0.0, (("de", FailureFlags.UNUSED_OPERATOR),), ()))
    cases.append(("de foo", False, 0.0, (("de", FailureFlags.UNUSED_OPERATOR), ("foo", FailureFlags.UNKNOWN_TERM)), ()))
    cases.append(("un medio de un segundo", True, 0.5, (), ((0.5, Scale(scale=1.0)),)))
    cases.append(("0 un segundos", True, 1.0, ((0.0, FailureFlags.LONELY_VALUE),), ((1.0, Scale(scale=1.0)),)))
...
def generate_strict_tests() -> list[ParseCase]:
    ...
    cases.append(("de foo", False, 0.0, (("de", FailureFlags.UNUSED_OPERATOR), ("foo", FailureFlags.UNKNOWN_TERM)), ()))
    cases.append(("un medio de un segundo", True, 0.5, (), ((0.5, Scale(scale=1.0)),)))
    cases.append(("0 un segundos", False, 1.0, ((0.0, FailureFlags.LONELY_VALUE),), ((1.0, Scale(scale=1.0)),)))
