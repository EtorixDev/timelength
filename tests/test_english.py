...
from timelength import TimeLength, Scale, ParserSettings, English, FailureFlags, ParsedTimeLength
...
def generate_notstrict_tests():
    ...
    cases.append((f"2 of", False, 0.0, ((f"of", FailureFlags.UNUSED_OPERATOR), (2.0, FailureFlags.LONELY_VALUE),), (),))
    ...
    cases.append(("one billion billion billion billion billion years", True, 3.1536000000000003e+52, (), ((1.0000000000000001e+45, Scale(scale = 31536000.0)),),))
