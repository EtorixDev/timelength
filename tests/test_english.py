...
def generate_notstrict_tests():
    ...
    cases.append(("half half twenty three min", True, 345, [], [(5.75, Scale(scale = 60))],))
    cases.append(("half of half of twenty three min", True, 345, [], [(5.75, Scale(scale = 60))],))
    cases.append(("half of half twenty three min", True, 345, [], [(5.75, Scale(scale = 60))],))
    cases.append(("half half of twenty three min", True, 345, [], [(5.75, Scale(scale = 60))],))
    cases.append(("twenty-three of half half mins", True, 345, [], [(5.75, Scale(scale = 60))],))
    cases.append(("twenty-three half half of min", True, 345, [], [(5.75, Scale(scale = 60))],))
    cases.append(("a million seconds half", True, 1000000.0, [(0.5, FailureFlags.LONELY_VALUE)], [(1000000.0, Scale(scale = 1.0))],))
    cases.append(("a million seconds half of", True, 1000000.0, [("of", FailureFlags.UNUSED_MULTIPLIER), (0.5, FailureFlags.LONELY_VALUE)], [(1000000.0, Scale(scale = 1.0))],))
...
def generate_strict_tests():
    ...
    cases.append(("a million seconds half of", False, 1000000.0, [("of", FailureFlags.UNUSED_MULTIPLIER), (0.5, FailureFlags.LONELY_VALUE)], [(1000000.0, Scale(scale = 1.0))],))
